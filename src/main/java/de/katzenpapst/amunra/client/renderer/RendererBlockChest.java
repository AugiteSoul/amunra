...
public class RendererBlockChest implements ISimpleBlockRenderingHandler
{
    final int renderID;

    public RendererBlockChest(int var1)
    {
        this.renderID = var1;
    }
    ...
    {
//    	if (par1Block instanceof ARChest)
        if (par1Block == ARBlocks.testChest)
        {
